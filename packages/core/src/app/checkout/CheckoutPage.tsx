...
const Checkout = ({
    ...
    if (state.error) {
        ...
        return (
            <div className={classNames('remove-checkout-step-numbers', { 'is-embedded': isEmbedded() }, { 'themeV2': enhancedThemeV1 })} data-test="checkout-page-container" id="checkout-page-container">
